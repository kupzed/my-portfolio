/**
 * @file data.ts
 * @description Central data layer for all portfolio content.
 *              Import named exports into components — no hardcoded arrays elsewhere.
 */
...
import { FileCode2, Github, Linkedin, Mail, Code, GraduationCap, Briefcase } from 'lucide-react';
...
export const SKILL_TABS = ['Frontend', 'Backend', 'Tools & Tech', 'Design'] as const;
...
export const skillsByTab: Record<SkillTab, Skill[]> = {
  ...
  'Tools & Tech': [
    ...
    { name: 'Smart Contracts', icon: FileCode2 as Skill['icon'], color: '#8B5CF6' },
    { name: 'Web3', icon: SiWeb3Dotjs, color: '#F16822' },
    { name: 'Solidity', icon: SiSolidity, color: '#000000', darkColor: '#ffffff' },
    { name: 'Anthropic', icon: SiAnthropic, color: '#000000', darkColor: '#ffffff' },
    { name: 'Google Gemini', icon: SiGooglegemini, color: '#000000', darkColor: '#ffffff' },
  ...
  Design: [
    ...
    { name: 'Adobe Acrobat XI Pro', icon: SiAdobeacrobatreader, color: '#FF0000' },
    { name: 'CorelDRAW', icon: SiCoreldraw, color: '#000000', darkColor: '#ffffff' },
...
export const projects: Project[] = [
  {
    ...
    tech: [
      ...
      { icon: SiJsonwebtokens, color: '#000000', darkColor: '#ffffff', label: 'JWT Auth' },
      ...
      { icon: SiGithub, color: '#181717', darkColor: '#e6edf3', label: 'GitHub' },
    ...
    links: [
      { label: 'Frontend', href: 'https://github.com/kupzed/indogreen-frontend', variant: 'primary' },
      { label: 'Backend', href: 'https://github.com/kupzed/indogreen-backend', variant: 'secondary' },
    ],
  ...
  },
  {
    ...
    tech: [
      { icon: SiNextdotjs, color: '#000000', darkColor: '#ffffff', label: 'Next.js' },
      ...
      { icon: SiGithub, color: '#181717', darkColor: '#e6edf3', label: 'GitHub' },
      { icon: SiGithubactions, color: '#2088FF', label: 'GitHub Actions' },
      { icon: SiVercel, color: '#000000', darkColor: '#ffffff', label: 'Vercel' },
    ],
    links: [
      { label: 'Frontend', href: 'https://github.com/kupzed/my-portfolio', variant: 'primary' },
      { label: 'Backend', href: 'https://github.com/kupzed/my-portfolio', variant: 'secondary' },
    ],
  ...
  },
  {
    ...
    links: [
      { label: 'Frontend', href: 'https://github.com/kupzed/indogreen-frontend-v2', variant: 'primary' },
      { label: 'Backend', href: 'https://github.com/kupzed/indogreen-backend', variant: 'secondary' },
    ],
  ...
  },
  {
    ...
    tech: [
      ...
      { icon: SiExpress, color: '#000000', darkColor: '#ffffff', label: 'Express.js' },
      { icon: SiMysql, color: '#4479A1', label: 'MySQL' },
    ...
    links: [
      { label: 'Frontend', href: 'https://github.com/kupzed/InnerStrength-Full', variant: 'primary' },
      { label: 'Backend', href: 'https://github.com/kupzed/InnerStrength-Full', variant: 'secondary' },
    ],
  ...
  },
  {
    ...
    tech: [
      { icon: SiAdobeillustrator, color: '#FF9A00', label: 'Adobe Illustrator' },
      { icon: SiAdobephotoshop, color: '#31A8FF', label: 'Adobe Photoshop' },
      { icon: SiAdobelightroom, color: '#31A8FF', label: 'Adobe Lightroom' },
      { icon: SiAdobeacrobatreader, color: '#FF0000', label: 'Adobe Acrobat XI Pro' },
